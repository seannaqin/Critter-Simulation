...
public class CritterFrame extends JFrame {
    ...
    public CritterFrame(int width, int height) {
        ...
        setTitle("APCS critter simulation (originally from UW CSE 142)");
    ...
    public void add(int number, String className)
    {
    	try
    	{
    		add(number, Class.forName(className));
    	}
    	catch (ClassNotFoundException e)
    	{
    		System.out.println("Did not find class with name: " + className);
    	}
    }
